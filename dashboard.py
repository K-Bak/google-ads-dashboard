...
SHEET_ID = "1qGfpJ5wTqLAFtDmKaauOXouAwMKWhIBg9bIyWPEbkzc"  # Google Ads
...
# ---------- Konstanter --------------------------------------------------------
YEAR_GOAL = 250_000   # årsmål 2025
Q4_GOAL   = 133_000   # Q4-mål (ændr her hvis nødvendigt)
START_UGE = 40
SLUT_UGE  = 51
YEAR      = 2025

# ---------- Filtre ------------------------------------------------------------
mask_q4   = df["Uge"].between(START_UGE, SLUT_UGE)
mask_year = df["År"] == YEAR

df_q4     = df[mask_q4 & mask_year]
...
st.markdown(
    ...
    "Google Ads – Q4</h1>", unsafe_allow_html=True)
